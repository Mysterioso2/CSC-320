...
public class CriticalThinking3v2 {
	...
	public static void main(String[] args) {
		...
		if(incomeWeek1 < 500){
			...
			taxesWeek1 = incomeWeek1 * 0.30;
			System.out.println("You were taxed $" + taxesWeek1 + " (30%) for this week.\n");
			}
		...
		if(incomeWeek2 < 500){
			...
			taxesWeek2 = incomeWeek2 * 0.30;
			System.out.println("You were taxed $" + taxesWeek2 + " (30%) for this week.\n");
			}
		...
		if(incomeWeek3 < 500){
			...
			taxesWeek3 = incomeWeek3 * 0.30;
			System.out.println("You were taxed $" + taxesWeek3 + " (30%) for this week.\n");
			}
		...
		if(incomeWeek4 < 500){
			...
			taxesWeek4 = incomeWeek4 * 0.3;
			System.out.println("You were taxed $" + taxesWeek4 + " (30%) for this week.\n");
			}
